...
int main()
{
    ...
    world.add(make_shared<sphere>(point3(0, 1.2, 0), 0.2, material4));
    world.add(make_shared<sphere>(point3(0, 1.4, 0), 0.2, material4));
    world.add(make_shared<sphere>(point3(0, 1.6, 0), 0.2, material4));
    world.add(make_shared<sphere>(point3(0, 1.8, 0), 0.2, material4));
    world.add(make_shared<sphere>(point3(0, 2, 0), 0.2, material4));
